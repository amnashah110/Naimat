      ...
      {!showSignupForm && !showLoginForm ? (
        <>
          ...
          <div className="login-signup-choice">
            <button className="choice-btn" onClick={() => { setShowLoginForm(true); setStep(1); }}>
              Log In
            </button>
            <button className="choice-btn" onClick={() => { setShowSignupForm(true); setStep(1); }}>
              Sign Up
            </button>
          </div>
        ...
        <>
          ...
          {step === 1 && (
            <>
              <div className="role-toggle">
                ...
                <button className={role === "recipient" ? "active" : ""} onClick={() => setRole("recipient")}>Recipient</button>
          ...
          {step === 2 && (
            <form className="signup-form" onSubmit={(e) => { e.preventDefault(); alert("Logged in successfully!"); }}>
              <h3>Enter OTP</h3>
              <input type="text" placeholder="Enter 6-digit OTP" maxLength="6" />
              <button type="submit" className="submit-btn">Verify & Log In</button>
              <p className="back-option" onClick={() => setStep(1)}>← Back</p>
            </form>
          )}
        </>
      ) : (
        <>
          ...
          {/* STEP 2: OTP */}
          {step === 2 && (
            <form className="signup-form" onSubmit={(e) => { e.preventDefault(); setStep(3); }}>
              <h3>Verify OTP</h3>
              <input type="text" placeholder="Enter 6-digit OTP" maxLength="6" />
          ...
          {/* STEP 3: Fill Details */}
          {step === 3 && (
            <form className="signup-form" onSubmit={(e) => { e.preventDefault(); alert("User Registered Successfully!"); }}>
              ...
              {phone.length > 0 && phone.length < 10 && (
                <p className="error-text">Must be 10 digits (after +92)</p>
              )}
              ...
              <button type="submit" className="submit-btn">Sign Up as {role}</button>
              <p className="back-option" onClick={() => setStep(2)}>← Back</p>
            </form>
          )}
        </>
      )}
