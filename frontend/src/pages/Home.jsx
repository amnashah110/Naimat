...
function Home() {
  ...
  const handleRequestOTP = async (emailInput, isSignup = false) => {
    ...
    try {
      const response = await fetch("naimat-backend-f9drh3fcceewebcd.southeastasia-01.azurewebsites.net/auth/passwordless/requestcode", {
        method: "POST",
        headers: {
  ...
  const handleVerifyOTP = async (emailInput, otpCode, isSignup = false) => {
    ...
    try {
      const response = await fetch("naimat-backend-f9drh3fcceewebcd.southeastasia-01.azurewebsites.net/auth/passwordless/verifycode", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleSignupUser = async (userData) => {
    ...
    try {
      const response = await fetch("naimat-backend-f9drh3fcceewebcd.southeastasia-01.azurewebsites.net/auth/signup", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
