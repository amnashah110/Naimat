...
function Receiver() {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://naimat-backend-f9drh3fcceewebcd.southeastasia-01.azurewebsites.net/donation/search', {
        method: 'POST',
        headers: {
  ...
  const fetchDonorEmail = async (donationId) => {
    try {
      ...
      const response = await fetch(`https://naimat-backend-f9drh3fcceewebcd.southeastasia-01.azurewebsites.net/donation/notify-donor/${donationId}`, {
        method: 'POST',
        headers: {
  ...
  const handleSubmitDelivery = async () => {
    ...
    try {
      ...
      const response = await fetch('https://naimat-backend-f9drh3fcceewebcd.southeastasia-01.azurewebsites.net/delivery-post/create', {
        method: 'POST',
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json",
